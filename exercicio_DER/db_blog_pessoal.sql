...
-- -----------------------------------------------------
-- Table `db_blog_pessoal`.`tb-temas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_blog_pessoal`.`tb-temas` (
...
CREATE TABLE IF NOT EXISTS `db_blog_pessoal`.`tb_postagens` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_tb_postagens_tb-temas_idx` (`tema_id` ASC) VISIBLE,
  INDEX `fk_tb_postagens_tb_usuarios1_idx` (`usuario_id` ASC) VISIBLE,
  CONSTRAINT `fk_tb_postagens_tb-temas`
    FOREIGN KEY (`tema_id`)
    REFERENCES `db_blog_pessoal`.`tb-temas` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
